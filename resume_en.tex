...
\noindent
C, C++, Python, JavaScript, PHP, UNIX shell scripting.\\
Working knowledge of Ada, MIPS assembler, Perl and Go.
...
\noindent
\textsc{Frontend:} HTML5 \amper{} CSS3, JavaScript, AngularJS 1.x, jQuery \amper{} jQuery Mobile, PhoneGap, Processing.js, Raphaël.\\
\textsc{Backend:} MVC frameworks based on PHP (CakePHP) and Python (Django, Flask, Bottle).
