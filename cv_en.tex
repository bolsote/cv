...
%\textsc{Lead developer}, \href{http://www.iteisa.com}{ITEISA Desarrollo y Sistemas, S.L.}
...
\years{2011}\textsc{HW/SW engineer}, \href{http://www.tedesys.com}{TEDESYS Global, S.L.}\\
Design and implementation of a stereo vision system.\\
\years{2011-2012}\textsc{Lead developer}, \href{http://www.iteisa.com}{ITEISA Desarrollo y Sistemas, S.L.}
...
\noindent
	\textsc{User interfaces}: Extensive usage of W3C standards: HTML4, XHTML, HTML5, CSS. Development of client--side dynamic websites with JavaScript \amper{} jQuery.\\
	\textsc{MVC frameworks}: Extensive usage of both PHP (CakePHP) and Python--based (Django, Grok) web frameworks.\\
	\textsc{Database management systems}: Knowledge of relational database design, optimization and administration ---MySQL, PostgreSQL. Minor experience with NoSQL databases ---MongoDB.\\
